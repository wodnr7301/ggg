   ...
   <div class="container-fluid px-4">
      <div class="card">
         <div class="card-body" style="height: auto;">
            <a href="boardList" style="color: #2E9AFE; font-size: 14px;">질의응답 목록 ></a><br />
            ...
            <div class="button">
               ...
               <c:if test="${user.empNo eq freeBbs.empNo}">
               		<button class="btn btn-light btn-sm" type="button" onclick="location='boardUpdate?fbNo=${freeBbs.fbNo}'">수정</button>
...
<script>
    ...
    function confirmDelete(fbNo) {
        if (confirm("정말로 삭제하시겠습니까?")) {
            location.href = 'boardDelete?fbNo=' + fbNo;
        } else {
            alert("삭제를 취소하였습니다");
        }
    }
