   ...
   <div class="container-fluid px-4">
      <div class="card">
         <div class="card-body" style="height: auto;">
            <a href="ntcBoardList" style="color: #2E9AFE; font-size: 14px;">가맹점주 공지사항 목록 ></a><br />
            ...
            <div class="button">
               <br />
               <button class="btn btn-light btn-sm" type="button" onclick="location='ntcBoardUpdate?nbNo=${ntcBbs.nbNo}'">수정</button>
...
<script>
    ...
    function confirmDelete(nbNo) {
        if (confirm("정말로 삭제하시겠습니까?")) {
            location.href = 'ntcBoardDelete?nbNo=' + nbNo;
        } else {
            alert("삭제를 취소하였습니다");
        }
    }
