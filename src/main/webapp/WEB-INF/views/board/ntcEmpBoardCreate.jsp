...
.dropdown-menu {
    min-width: 14rem; /* 드롭다운 메뉴 최소 너비 설정 */
}
...
<div class="centered-container post-content-container">
    <div class="card card-header-actions mb-4 mb-lg-0">
        <div class="card-header">
            공지사항 게시판
        <div><a href="ntcEmpBoardList" style="color: #2E9AFE; font-size: 15px;"> 공지목록 > </a></div>
        </div>
        <div class="card-body">
            <form action="/employee/ntcEmpBoardCreate" method="post">
