...
<div class="container-fluid px-4">
    <div class="card">
        <div class="card-body">
                ...
                <tbody>
				    <c:forEach var="freeBbs" items="${freeBbsList}" varStatus="stat">
				        <tr>
				            ...
				            <td><a href="boardDetail?fbNo=${freeBbs.fbNo}" style="color: #585858;">${freeBbs.fbTtl}</a></td>
        	...
        	<c:if test="${empClsf eq 'A302'}">
            	<a class="btn btn-primary lift" href="boardCreate" style="float: right; position: relative; top: -36px;">작성하기</a>
            </c:if>
        </div>
    </div>
</div>
