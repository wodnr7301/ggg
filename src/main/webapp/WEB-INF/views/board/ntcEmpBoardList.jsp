    ...
    <div class="container-xl px-4">
        <div class="page-header-content pt-4">
            <div class="row align-items-center justify-content-between">
                <div class="col-auto mt-4 d-flex justify-content-between align-items-center w-100">
                    <div>
    ...
    <div class="card">
        <div class="card-body">
            <table id="datatablesSimple-nctBbs">
                ...
                <tbody>
           		<c:forEach var="ntcBbs" items="${ntcBbsList}" varStatus="stat">
                    <tr>
                        ...
                        <td>
				            <a href="ntcEmpBoardDetail?nbNo=${ntcBbs.nbNo}" style="color: #585858;">
				                <c:choose>
           	...
           	<c:if test="${empClsf eq 'A301' and empJbgdNm eq 'A102' and deptNo eq 'A003'}"><br/>
				<a class="btn btn-primary" href="ntcEmpBoardCreate" style="float: right; position: relative; top: -36px;">작성하기</a>
			</c:if>
        </div>
    </div>
</div>
