...
<style>
 #beforeApvBoxTable td:nth-child(1), td:nth-child(3), td:nth-child(5), td:nth-child(6), td:nth-child(8), td:nth-child(7){
	   text-align: center;
	   width: 12%;
}
</style>
...
<div class="container-fluid px-4">
	...
	<nav class="nav nav-borders">
		<a class="nav-link active ms-0" href="/eatrzt/beforeApvBoxList">결재대기문서함</a>
...
<script>
$(function(){
	const beforeApvBoxTable = document.getElementById('beforeApvBoxTable');
	if (beforeApvBoxTable) {
		new simpleDatatables.DataTable(beforeApvBoxTable, {
			perPage : 10,
			labels : {
				placeholder : "Search...",
