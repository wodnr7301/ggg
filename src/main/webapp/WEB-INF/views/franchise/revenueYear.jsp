...
<main>
                        ...
                        <h1 class="page-header-title">
                            <div class="page-header-icon">
                                <i data-feather="bar-chart"></i>
                                   	...
                                   	연도별 매출 현황 / ${revenueList[0].frcsNm}
                        </h1>
    ...
    <div class="gTable">
        ...
        <div class="card-footer small text-muted">[연도별] 매출 총액 기준 통계 그래프</div>
        ...
        <table class="table table-striped table-hover table-bordered table-sm" id="revenueTable">
            <thead class="table-light" id="header-table">
                <tr>
                    ...
                    <th scope="col">연간 인건비</th>
                    <th scope="col">연간 판매비</th>
                    <th scope="col">연간 관리비</th>
                    <th scope="col">연간 순수익
            ...
            <tbody>
                <c:forEach var="revenue" items="${revenueList}" varStatus="stat">
                    <tr class="revenueArea" id="middel-table" data-bs-toggle="modal" data-bs-target="#exampleModalScrollable">
                        <td scope="row">${revenue.fsWrtYear}년</td>
                        <td class="number-format"><em style="color: #584D4D;"><fmt:formatNumber type="number" maxFractionDigits="3" value="${revenue.totalFsAmt}" />원</em></td>
                        <td class="number-format"><em style="color: #5882FA;"><fmt:formatNumber type="number" maxFractionDigits="3" value="${revenue.totalFsCost}" />원</em></td>
                        <td class="number-format"><em style="color: #FF6666;"><fmt:formatNumber type="number" maxFractionDigits="3" value="${revenue.totalFsEarn}" />원</em></td>
                        <td class="number-format"><fmt:formatNumber type="number" maxFractionDigits="3" value="${revenue.totalFsLbrco}" />원</td>
                        <td class="number-format"><fmt:formatNumber type="number" maxFractionDigits="3" value="${revenue.totalFsNtslAmt}" />원</td>
                        <td class="number-format"><fmt:formatNumber type="number" maxFractionDigits="3" value="${revenue.totalFsMngAmt}" />원</td>
                        <td class="number-format"><em style="color: #0C9C56;"><fmt:formatNumber type="number" maxFractionDigits="3" value="${revenue.totalFsOp}" />원</em></td>
                        <td class="number-format"><em style="color: #5858FA;"><fmt:formatNumber type="number" maxFractionDigits="3" value="${revenue.totalFsExpense}" />원</em></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table><hr/>
        <div class="small-text">
	        <b style="color:#848484">● 가맹점주님의 연간 순이익 계산 방식은 아래와 같습니다. 각 항목을 다음과 같은 알파벳으로 정의하여 계산합니다.</b>&nbsp;&nbsp;&nbsp;
            ...
            <div class="modal-body" id="myModel">
                    <div class="row">
                        <div class="col-lg-6 split-col" style="width: 100%;">
                            ...
                            <div class="card">
                                <div class="card-header">연간 지출</div>
                            ...
                            <div class="card">
                                <div class="card-header">연간 수익</div>
                                <div class="card-body">
                                    <table class="table">
...
var totalFsOp = [];
var totalFsExpense = [];
var fsWrtYear = ['2024년', '2023년', '2022년', '2021년', '2020년'];
var myChart;

<c:forEach var="revenue" items="${revenueList}">
	totalFsAmt.push(${revenue.totalFsAmt});
	totalFsCost.push(${revenue.totalFsCost});
	totalFsEarn.push(${revenue.totalFsEarn});
	totalFsLbrco.push(${revenue.totalFsLbrco});
	totalFsNtslAmt.push(${revenue.totalFsNtslAmt});
	totalFsMngAmt.push(${revenue.totalFsMngAmt});
	totalFsOp.push(${revenue.totalFsOp});
	totalFsExpense.push(${revenue.totalFsExpense});
</c:forEach>
...
data: {
    ...
    datasets: [{
        ...
        data: totalFsAmt,
        borderWidth: 1,
        backgroundColor: 'rgb(250,30,30,0.6)',
        borderColor: 'rgb(250,30,30,0.6)'
    },
    {
        label: '제품원가',
        data: totalFsCost,
        borderWidth: 1,
        backgroundColor: 'rgb(10, 135, 247, 0.6)',
        borderColor: 'rgb(10, 135, 247, 0.6)'
    },
    {
        label: '매출 총 액 ',
        data: totalFsEarn,
        borderWidth: 1,
        backgroundColor: 'rgb(251,107,23,0.6)',
        borderColor: 'rgb(251,107,23,0.6)'
    },
    {
        label: '인건비',
        data: totalFsLbrco,
        borderWidth: 1,
        backgroundColor: 'rgb(103,81,79,0.6)',
        borderColor: 'rgb(103,81,79,0.6)'
    },
    {
        label: '판매비',
        data: totalFsNtslAmt,
    ...
    },
    {
        ...
        data: totalFsOp,
        borderWidth: 1,
        backgroundColor: 'rgb(38,172,26,0.6)',
        borderColor: 'rgb(38,172,26,0.6)'
    },
    {
        label: '총 지출',
        data: totalFsExpense,
        borderWidth: 1,
        backgroundColor: 'rgb(9,83,209,0.6)',
        borderColor: 'rgb(9,83,209,0.6)'
    }]
},
options: {
    scales: {
