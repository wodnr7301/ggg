...
public class EmpFreeBbsController {
	...
	public String boardList(Model model, Principal principal) {
		...
		List<FreeBbsVO> freeBbsList = this.freeBbsService.empBoardList();
	...
	public String boardCreate(@Validated @ModelAttribute(value="freeBbsVO") FreeBbsVO freeBbsVO,
	    ...
	    if (brResult.hasErrors()) {
	        ...
	        return "employee/empBoardCreate";
	    }
	    ...
	    log.info("EmpBoardCreate -> EmpResult : " + result);
	    log.info("EmpBoardCreate-> EmpFreeBbsVO: " + freeBbsVO);

	    return "redirect:/employee/empBoardList";
	}
	 ...
	 *
	 */
	@PostMapping("/empBoardUpdate")
	public String boardUpdate(FreeBbsVO freeBbsVO, Model model) {
		log.info("직원 게시판 Update에 진입! (Post)");
	 ...
	 */
	@GetMapping("/profile")
	public String detail2(ModelAndView mav) {
