...
public class NtcEmpBbsController {

	@Autowired
	NtcBbsService ntcBbsService;
	
	@GetMapping("/ntcEmpBoardList")
	public String empNtcBoardList(Model model, Principal principal) {
		...
		if (principal != null) {
	        ...
	        if (cu != null) {
	            ...
	            if (emp != null) {
	                ...
	                model.addAttribute("empJbgdNm", emp.getEmpJbgdNm());
	                model.addAttribute("deptNo", emp.getDeptNo());
	            }
	        }
	    }
		return "board/ntcEmpBoardList";
	}
	

	@GetMapping("/ntcEmpBoardDetail")
	public String ntcBoardDetail(@RequestParam("nbNo") String nbNo, Model model, Principal principal) {
	    ...
	    return "board/ntcEmpBoardDetail";
	}


	

	@GetMapping("/ntcEmpBoardCreate")
    public String showCreateNtcBoardForm(Model model) {
        ...
        return "board/ntcEmpBoardCreate"; 
    }
	
	@PostMapping("/ntcEmpBoardCreate")
	public String ntcBoardCreate(@Validated @ModelAttribute(value="NtcBbsVO") NtcBbsVO ntcBbsVO,
	    ...
	    if (brResult.hasErrors()) {
	        ...
	        return "employee/ntcEmpBoardCreate";
	    }
	    ...
	    log.info("본사 공지사항 boardCreate -> result : " + result);
	    log.info("본사 공지사항 boardCreate-> ntcBbsVO: " + ntcBbsVO);

	    return "redirect:/employee/ntcEmpBoardList";
	    
	}
	
	@GetMapping("/ntcEmpBoardUpdate")
    public String boardUpdate(@RequestParam("nbNo") String nbNo, Model model) {
        ...
        return "board/ntcEmpBoardUpdate";  
    }
	
	@PostMapping("/ntcEmpBoardUpdate")
